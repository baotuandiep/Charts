...
open class CHBarHighlighter: CHChartHighlighter
{
    open override func getHighlight(x: CGFloat, y: CGFloat) -> CHHighlight?
    {
        guard
            let barData = (self.chart as? CHBarChartDataProvider)?.barData,
    ...
    internal override var data: CHChartData?
    {
        return (chart as? CHBarChartDataProvider)?.barData
    }
    ...
    /// - parameter yValue:
    /// - returns:
    @objc open func getStackedHighlight(high: CHHighlight,
                                  set: CHIBarChartDataSet,
                                  xValue: Double,
                                  yValue: Double) -> CHHighlight?
    {
        guard
    ...
    /// - parameter value:
    /// - returns:
    @objc open func getClosestStackIndex(ranges: [CHRange]?, value: Double) -> Int
    {

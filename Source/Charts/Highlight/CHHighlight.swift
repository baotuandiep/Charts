...
@objc(ChartHighlight)
open class CHHighlight: NSObject
{
    ...
    private var _axis: CHYAxis.AxisDependency = CHYAxis.AxisDependency.left
    ...
    @objc open var axis: CHYAxis.AxisDependency { return _axis }
...
// MARK: Equatable
extension CHHighlight /*: Equatable*/ {
    open override func isEqual(_ object: Any?) -> Bool {
        guard let object = object as? CHHighlight else { return false }

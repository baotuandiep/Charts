...
open class CHViewPortHandler: NSObject
{
    ...
    @objc open func centerViewPort(pt: CGPoint, chart: CHChartViewBase)
    {
        let translateX = pt.x - offsetLeft
        let translateY = pt.y - offsetTop
    ...
    @objc @discardableResult open func refresh(newMatrix: CGAffineTransform, chart: CHChartViewBase, invalidate: Bool) -> CGAffineTransform
    {

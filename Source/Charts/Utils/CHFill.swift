...
open class CHFill: NSObject
{
    ...
    @objc open class func fillWithCGColor(_ CGColor: CGColor) -> CHFill
    {
        return CHFill(CGColor: CGColor)
    }
    
    @objc open class func fillWithColor(_ color: NSUIColor) -> CHFill
    {
        return CHFill(color: color)
    }
    
    @objc open class func fillWithLinearGradient(
        _ linearGradient: CGGradient,
        angle: CGFloat) -> CHFill
    {
        return CHFill(linearGradient: linearGradient, angle: angle)
    }
    ...
    @objc open class func fillWithRadialGradient(_ radialGradient: CGGradient) -> CHFill
    {
        return CHFill(radialGradient: radialGradient)
    }
    
    @objc open class func fillWithCGImage(_ CGImage: CGImage, tiled: Bool) -> CHFill
    {
        return CHFill(CGImage: CGImage, tiled: tiled)
    }
    
    @objc open class func fillWithImage(_ image: NSUIImage, tiled: Bool) -> CHFill
    {
        return CHFill(image: image, tiled: tiled)
    }
    
    @objc open class func fillWithCGImage(_ CGImage: CGImage) -> CHFill
    {
        return CHFill(CGImage: CGImage)
    }
    
    @objc open class func fillWithImage(_ image: NSUIImage) -> CHFill
    {
        return CHFill(image: image)
    }
    
    @objc open class func fillWithCGLayer(_ CGLayer: CGLayer) -> CHFill
    {
        return CHFill(CGLayer: CGLayer)
    }

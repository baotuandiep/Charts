...
open class CHChartUtils
{
    private static var _defaultValueFormatter: CHIValueFormatter = CHChartUtils.generateDefaultValueFormatter()
    ...
    private class func generateDefaultValueFormatter() -> CHIValueFormatter
    {
        let formatter = CHDefaultValueFormatter(decimals: 1)
        return formatter
    }
    
    /// - returns: The default value formatter used for all chart components that needs a default
    open class func defaultValueFormatter() -> CHIValueFormatter
    {

...
open class CHAxisRendererBase: CHRenderer
{
    /// base axis this axis renderer works with
    @objc open var axis: CHAxisBase?
    
    /// transformer to transform values to screen pixels and return
    @objc open var transformer: CHTransformer?

    @objc public init(viewPortHandler: CHViewPortHandler, transformer: CHTransformer?, axis: CHAxisBase?)
    {

...
open class CHBarLineScatterCandleBubbleRenderer: CHDataRenderer
{
    internal var _xBounds = XBounds() // Reusable XBounds object
    
    public override init(animator: CHAnimator, viewPortHandler: CHViewPortHandler)
    {
        super.init(animator: animator, viewPortHandler: viewPortHandler)
    }
    
    /// Checks if the provided entry object is in bounds for drawing considering the current animation phase.
    internal func isInBoundsX(entry e: CHChartDataEntry, dataSet: CHIBarLineScatterCandleBubbleChartDataSet) -> Bool
    {
    ...
    internal func xBounds(chart: CHBarLineScatterCandleBubbleChartDataProvider,
                          dataSet: CHIBarLineScatterCandleBubbleChartDataSet,
                          animator: CHAnimator?) -> XBounds
    {
        return XBounds(chart: chart, dataSet: dataSet, animator: animator)
    }
    
    /// - returns: `true` if the DataSet values should be drawn, `false` if not.
    internal func shouldDrawValues(forDataSet set: CHIChartDataSet) -> Bool
    {
    ...
    open class XBounds
    {
        ...
        public init(chart: CHBarLineScatterCandleBubbleChartDataProvider,
                    dataSet: CHIBarLineScatterCandleBubbleChartDataSet,
                    animator: CHAnimator?)
        {
        ...
        open func set(chart: CHBarLineScatterCandleBubbleChartDataProvider,
                      dataSet: CHIBarLineScatterCandleBubbleChartDataSet,
                      animator: CHAnimator?)
        {

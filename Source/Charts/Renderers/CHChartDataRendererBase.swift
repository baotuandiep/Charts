...
open class CHDataRenderer: CHRenderer
{
    ...
    @objc open let animator: CHAnimator
    
    @objc public init(animator: CHAnimator, viewPortHandler: CHViewPortHandler)
    {
    ...
    @objc open func drawHighlighted(context: CGContext, indices: [CHHighlight])
    {
    ...
    @objc open func isDrawingValuesAllowed(dataProvider: CHChartDataProvider?) -> Bool
    {
    ...
    @objc internal func createAccessibleHeader(usingChart chart: CHChartViewBase,
                                        andData data: CHChartData,

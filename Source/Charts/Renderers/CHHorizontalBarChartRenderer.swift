...
open class CHHorizontalBarChartRenderer: CHBarChartRenderer
{
    ...
    public override init(dataProvider: CHBarChartDataProvider, animator: CHAnimator, viewPortHandler: CHViewPortHandler)
    {
    ...
    open override func drawDataSet(context: CGContext, dataSet: CHIBarChartDataSet, index: Int)
    {
    ...
    open override func isDrawingValuesAllowed(dataProvider: CHChartDataProvider?) -> Bool
    {
    ...
    internal override func setHighlightDrawPos(highlight high: CHHighlight, barRect: CGRect)
    {

...
open class CHScatterChartRenderer: CHLineScatterCandleRadarRenderer
{
    @objc open weak var dataProvider: CHScatterChartDataProvider?
    
    @objc public init(dataProvider: CHScatterChartDataProvider, animator: CHAnimator, viewPortHandler: CHViewPortHandler)
    {
    ...
    open override func drawData(context: CGContext)
    {
        ...
        if let chart = dataProvider as? CHScatterChartView {
        ...
        for i in 0 ..< scatterData.dataSetCount
        {
            ...
            if set.isVisible
            {
                if !(set is CHIScatterChartDataSet)
                {
                    fatalError("Datasets for ScatterChartRenderer must conform to IScatterChartDataSet")
                }
                
                drawDataSet(context: context, dataSet: set as! CHIScatterChartDataSet)
            }
        }
    }
    ...
    @objc open func drawDataSet(context: CGContext, dataSet: CHIScatterChartDataSet)
    {
    ...
    open override func drawValues(context: CGContext)
    {
        ...
        {
            guard let dataSets = scatterData.dataSets as? [CHIScatterChartDataSet] else { return }
    ...
    open override func drawHighlighted(context: CGContext, indices: [CHHighlight])
    {
        ...
        {
            guard
                let set = scatterData.getDataSetByIndex(high.dataSetIndex) as? CHIScatterChartDataSet,

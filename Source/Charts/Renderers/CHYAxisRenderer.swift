...
open class CHYAxisRenderer: CHAxisRendererBase
{
    @objc public init(viewPortHandler: CHViewPortHandler, yAxis: CHYAxis?, transformer: CHTransformer?)
    {
    ...
    {
        guard let yAxis = self.axis as? CHYAxis else { return }

...
open class CHYAxisRendererHorizontalBarChart: CHYAxisRenderer
{
    public override init(viewPortHandler: CHViewPortHandler, yAxis: CHYAxis?, transformer: CHTransformer?)
    {
    ...
    {
        guard let yAxis = axis as? CHYAxis else { return }
    ...
    {
        guard
            let yAxis = self.axis as? CHYAxis,

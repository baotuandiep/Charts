...
open class CHXAxisRendererHorizontalBarChart: CHXAxisRenderer
{
    internal weak var chart: CHBarChartView?
    
    @objc public init(viewPortHandler: CHViewPortHandler, xAxis: CHXAxis?, transformer: CHTransformer?, chart: CHBarChartView)
    {

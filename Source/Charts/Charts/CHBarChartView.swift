...
open class CHBarChartView: CHBarLineChartViewBase, CHBarChartDataProvider
{
    ...
    internal override func initialize()
    {
        ...
        renderer = CHBarChartRenderer(dataProvider: self, animator: _animator, viewPortHandler: _viewPortHandler)
        
        self.highlighter = CHBarHighlighter(chart: self)
    ...
    {
        guard let data = self.data as? CHBarChartData
            else { return }
    ...
    {
        highlightValue(CHHighlight(x: x, dataSetIndex: dataSetIndex, stackIndex: stackIndex))
    }
    ...
    open var barData: CHBarChartData? { return _data as? CHBarChartData }

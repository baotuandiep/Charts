...
open class CHRadarChartView: CHPieRadarChartViewBase
{
    ...
    private var _yAxis: CHYAxis!
    
    internal var _yAxisRenderer: CHYAxisRendererRadarChart!
    internal var _xAxisRenderer: CHXAxisRendererRadarChart!
    ...
    internal override func initialize()
    {
        ...
        _yAxis = CHYAxis(position: .left)
        
        renderer = CHRadarChartRenderer(chart: self, animator: _animator, viewPortHandler: _viewPortHandler)
        
        _yAxisRenderer = CHYAxisRendererRadarChart(viewPortHandler: _viewPortHandler, yAxis: _yAxis, chart: self)
        _xAxisRenderer = CHXAxisRendererRadarChart(viewPortHandler: _viewPortHandler, xAxis: _xAxis, chart: self)
        
        self.highlighter = CHRadarHighlighter(chart: self)
    }

...
open class CHPieRadarChartViewBase: CHChartViewBase
{
    ...
    private var _spinAnimator: CHAnimator!
    
    /// Applys a spin animation to the Chart.
    @objc open func spin(duration: TimeInterval, fromAngle: CGFloat, toAngle: CGFloat, easing: CHChartEasingFunctionBlock?)
    {
    ...
    @objc open func spin(duration: TimeInterval, fromAngle: CGFloat, toAngle: CGFloat, easingOption: CHChartEasingOption)
    {
    ...
    internal final func processRotationGestureEnded(location: CGPoint)
    {
        if isDragDecelerationEnabled
        {
            ...
            if _decelerationAngularVelocity != 0.0
            {
                ...
                _decelerationDisplayLink = NSUIDisplayLink(target: self, selector: #selector(CHPieRadarChartViewBase.decelerationLoop))
    ...
    private var _lastHighlight: CHHighlight!

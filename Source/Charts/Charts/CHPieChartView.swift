...
open class CHPieChartView: CHPieRadarChartViewBase
{
    ...
    internal override func initialize()
    {
        ...
        renderer = CHPieChartRenderer(chart: self, animator: _animator, viewPortHandler: _viewPortHandler)
        _xAxis = nil
        
        self.highlighter = CHPieHighlighter(chart: self)
    }
    ...
    internal override func calculateOffsets()
    {
        ...
        let shift = (data as? CHPieChartData)?.dataSet?.selectionShift ?? 0.0
    ...
    private func calcAngles()
    {
        ...
        let yValueSum = (_data as! CHPieChartData).yValueSum
    ...
    {
        return calcAngle(value: value, yValueSum: (_data as! CHPieChartData).yValueSum)
    }
    ...
    open override var xAxis: CHXAxis
    {

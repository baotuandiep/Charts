...
open class CHBarLineChartViewBase: CHChartViewBase, CHBarLineScatterCandleBubbleChartDataProvider, NSUIGestureRecognizerDelegate
{
    ...
    /// top axis.
    @objc open internal(set) var leftAxis = CHYAxis(position: .left)
    
    /// The right y-axis object. In the horizontal bar-chart, this is the
    /// bottom axis.
    @objc open internal(set) var rightAxis = CHYAxis(position: .right)

    /// The left Y axis renderer. This is a read-write property so you can set your own custom renderer here.
    /// **default**: An instance of YAxisRenderer
    @objc open lazy var leftYAxisRenderer = CHYAxisRenderer(viewPortHandler: _viewPortHandler, yAxis: leftAxis, transformer: _leftAxisTransformer)

    /// The right Y axis renderer. This is a read-write property so you can set your own custom renderer here.
    /// **default**: An instance of YAxisRenderer
    @objc open lazy var rightYAxisRenderer = CHYAxisRenderer(viewPortHandler: _viewPortHandler, yAxis: rightAxis, transformer: _rightAxisTransformer)
    
    internal var _leftAxisTransformer: CHTransformer!
    internal var _rightAxisTransformer: CHTransformer!
    
    /// The X axis renderer. This is a read-write property so you can set your own custom renderer here.
    /// **default**: An instance of XAxisRenderer
    @objc open lazy var xAxisRenderer = CHXAxisRenderer(viewPortHandler: _viewPortHandler, xAxis: _xAxis, transformer: _leftAxisTransformer)
    ...
    internal override func initialize()
    {
        ...
        _leftAxisTransformer = CHTransformer(viewPortHandler: _viewPortHandler)
        _rightAxisTransformer = CHTransformer(viewPortHandler: _viewPortHandler)
        
        self.highlighter = CHChartHighlighter(chart: self)
        ...
        #if !os(tvOS)
        _pinchGestureRecognizer = NSUIPinchGestureRecognizer(target: self, action: #selector(CHBarLineChartViewBase.pinchGestureRecognized(_:)))
    ...
    private var _closestDataSetToTouch: CHIChartDataSet!
        ...
        else if recognizer.state == NSUIGestureRecognizerState.ended || recognizer.state == NSUIGestureRecognizerState.cancelled
        {
            if _isDragging
            {
                if recognizer.state == NSUIGestureRecognizerState.ended && isDragDecelerationEnabled
                {
                    ...
                    _decelerationDisplayLink = NSUIDisplayLink(target: self, selector: #selector(CHBarLineChartViewBase.decelerationLoop))
    ...
    private func performPanChange(translation: CGPoint) -> Bool
    {
        ...
        if isTouchInverted()
        {
            if self is CHHorizontalBarChartView
            {
    ...
    @objc open func zoomAndCenterViewAnimated(
        ...
        axis: CHYAxis.AxisDependency,
        duration: TimeInterval,
        easingOption: CHChartEasingOption)
    {
    ...
    @objc open func setVisibleYRangeMaximum(_ maxYRange: Double, axis: CHYAxis.AxisDependency)
    {
    ...
    /// - parameter yRange:
    /// - parameter axis: - the axis for which this limit should apply
    @objc open func setVisibleYRangeMinimum(_ minYRange: Double, axis: CHYAxis.AxisDependency)
    {
    ...
    /// - parameter maxYRange:
    /// - parameter axis:
    @objc open func setVisibleYRange(minYRange: Double, maxYRange: Double, axis: CHYAxis.AxisDependency)
    {
    ...
    /// - parameter yValue:
    /// - parameter axis: - which axis should be used as a reference for the y-axis
    @objc open func moveViewToY(_ yValue: Double, axis: CHYAxis.AxisDependency)
    {
    ...
    /// - parameter yValue:
    /// - parameter axis: - which axis should be used as a reference for the y-axis
    @objc open func moveViewTo(xValue: Double, yValue: Double, axis: CHYAxis.AxisDependency)
    {
        let yInView = getAxisRange(axis: axis) / Double(_viewPortHandler.scaleY)
    ...
    @objc open func getAxisRange(axis: CHYAxis.AxisDependency) -> Double
    {
        if axis == .left
        {
    ...
    @objc open func getPosition(entry e: CHChartDataEntry, axis: CHYAxis.AxisDependency) -> CGPoint
    {
    ...
    /// `getPixelsForValues(...)`.
    @objc open func valueForTouchPoint(point pt: CGPoint, axis: CHYAxis.AxisDependency) -> CGPoint
    {
    ...
    @objc open func pixelForValues(x: Double, y: Double, axis: CHYAxis.AxisDependency) -> CGPoint
    {
        return getTransformer(forAxis: axis).pixelForValues(x: x, y: y)
    }
    
    /// - returns: The Entry object displayed at the touched position of the chart
    @objc open func getEntryByTouchPoint(point pt: CGPoint) -> CHChartDataEntry!
    {
    ...
    @objc open func getDataSetByTouchPoint(point pt: CGPoint) -> CHIBarLineScatterCandleBubbleChartDataSet?
    {
        let h = getHighlightByTouchPoint(pt)
        if h !== nil
        {
            return _data?.getDataSetByIndex(h!.dataSetIndex) as? CHIBarLineScatterCandleBubbleChartDataSet
        }
        return nil
    }
    ...
    @objc open func getAxis(_ axis: CHYAxis.AxisDependency) -> CHYAxis
    {
        if axis == .left
        {
            return leftAxis
    ...
    @objc open func setYAxisMinWidth(_ axis: CHYAxis.AxisDependency, width: CGFloat)
    {
        if axis == .left
        {
    ...
    @objc open func getYAxisMinWidth(_ axis: CHYAxis.AxisDependency) -> CGFloat
    {
        if axis == .left
        {
    ...
    @objc open func setYAxisMaxWidth(_ axis: CHYAxis.AxisDependency, width: CGFloat)
    {
        if axis == .left
        {
    ...
    @objc open func getYAxisMaxWidth(_ axis: CHYAxis.AxisDependency) -> CGFloat
    {
        if axis == .left
        {
    ...
    @objc open func getYAxisWidth(_ axis: CHYAxis.AxisDependency) -> CGFloat
    {
        if axis == .left
        {
    ...
    /// backwards.
    open func getTransformer(forAxis axis: CHYAxis.AxisDependency) -> CHTransformer
    {
        if axis == .left
        {
    ...
    open func isInverted(axis: CHYAxis.AxisDependency) -> Bool
    {

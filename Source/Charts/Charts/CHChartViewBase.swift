...
@objc
public protocol CHChartViewDelegate
{
    ...
    @objc optional func chartValueSelected(_ chartView: CHChartViewBase, entry: CHChartDataEntry, highlight: CHHighlight)
    
    // Called when nothing has been selected or an "un-select" has been made.
    @objc optional func chartValueNothingSelected(_ chartView: CHChartViewBase)
    
    // Callbacks when the chart is scaled / zoomed via pinch zoom gesture.
    @objc optional func chartScaled(_ chartView: CHChartViewBase, scaleX: CGFloat, scaleY: CGFloat)
    
    // Callbacks when the chart is moved / translated via drag gesture.
    @objc optional func chartTranslated(_ chartView: CHChartViewBase, dX: CGFloat, dY: CGFloat)
}

open class CHChartViewBase: NSUIView, CHChartDataProvider, CHAnimatorDelegate
{
    // MARK: - Properties
    ...
    /// labels)
    @objc open var xAxis: CHXAxis
    {
        return _xAxis
    }
    
    /// The default IValueFormatter that has been determined by the chart considering the provided minimum and maximum values.
    internal var _defaultValueFormatter: CHIValueFormatter? = CHDefaultValueFormatter(decimals: 0)
    
    /// object that holds all data that was originally set for the chart, before it was modified or any filtering algorithms had been applied
    internal var _data: CHChartData?
    ...
    internal var _xAxis: CHXAxis!
    
    /// The `Description` object of the chart.
    /// This should have been called just "description", but
    @objc open var chartDescription: CHDescription?
        
    /// The legend object containing all data associated with the legend
    internal var _legend: CHLegend!
    
    /// delegate to receive chart events
    @objc open weak var delegate: CHChartViewDelegate?
    ...
    internal var _legendRenderer: CHLegendRenderer!
    
    /// object responsible for rendering the data
    @objc open var renderer: CHDataRenderer?
    
    @objc open var highlighter: CHIHighlighter?
    
    /// object that manages the bounds and drawing constraints of the chart
    internal var _viewPortHandler: CHViewPortHandler!
    
    /// object responsible for animations
    internal var _animator: CHAnimator!
    
    /// flag that indicates if offsets calculation has already been done or not
    private var _offsetsCalculated = false
    
    /// array of Highlight objects that reference the highlighted slices in the chart
    internal var _indicesToHighlight = [CHHighlight]()
    ...
    @objc open var marker: CHIMarker?
    ...
    internal func initialize()
    {
        ...
        _animator = CHAnimator()
        _animator.delegate = self

        _viewPortHandler = CHViewPortHandler(width: bounds.size.width, height: bounds.size.height)
        
        chartDescription = CHDescription()
        
        _legend = CHLegend()
        _legendRenderer = CHLegendRenderer(viewPortHandler: _viewPortHandler, legend: _legend)
    ...
    internal func setupDefaultFormatter(min: Double, max: Double)
    {
        ...
        if _defaultValueFormatter is CHDefaultValueFormatter
        {
            // setup the formatter with a new number of digits
            let digits = reference.decimalPlaces
            
            (_defaultValueFormatter as? CHDefaultValueFormatter)?.decimals
             = digits
        }
    }
    ...
    open override func draw(_ rect: CGRect)
    {
        ...
        if _data === nil && noDataText.count > 0
        {
            ...
            CHChartUtils.drawMultilineText(
                context: context,
                text: noDataText,
    ...
    @objc open var highlighted: [CHHighlight]
    {
    ...
    @objc open func highlightValues(_ highs: [CHHighlight]?)
    {
        // set the indices to highlight
        _indicesToHighlight = highs ?? [CHHighlight]()
    ...
    @objc open func highlightValue(x: Double, y: Double, dataSetIndex: Int, dataIndex: Int = -1, callDelegate: Bool)
    {
        ...
        {
            highlightValue(CHHighlight(x: x, y: y, dataSetIndex: dataSetIndex, dataIndex: dataIndex), callDelegate: callDelegate)
        }
    }
    ...
    @objc open func highlightValue(_ highlight: CHHighlight?)
    {
        highlightValue(highlight, callDelegate: false)
    }

    /// Highlights the value selected by touch gesture.
    @objc open func highlightValue(_ highlight: CHHighlight?, callDelegate: Bool)
    {
        var entry: CHChartDataEntry?
        var h = highlight
    ...
    /// CandleStick-Chart.
    @objc open func getHighlightByTouchPoint(_ pt: CGPoint) -> CHHighlight?
    {
        if _data === nil
        {
    ...
    @objc open var lastHighlighted: CHHighlight?
    ...
    @objc open func getMarkerPosition(highlight: CHHighlight) -> CGPoint
    {
    ...
    @objc open var chartAnimator: CHAnimator!
    {
        return _animator
    }
    ...
    @objc open func animate(xAxisDuration: TimeInterval, yAxisDuration: TimeInterval, easingX: CHChartEasingFunctionBlock?, easingY: CHChartEasingFunctionBlock?)
    {
    ...
    @objc open func animate(xAxisDuration: TimeInterval, yAxisDuration: TimeInterval, easingOptionX: CHChartEasingOption, easingOptionY: CHChartEasingOption)
    {
    ...
    @objc open func animate(xAxisDuration: TimeInterval, yAxisDuration: TimeInterval, easing: CHChartEasingFunctionBlock?)
    {
    ...
    @objc open func animate(xAxisDuration: TimeInterval, yAxisDuration: TimeInterval, easingOption: CHChartEasingOption)
    {
    ...
    /// - parameter xAxisDuration: duration for animating the x axis
    /// - parameter easing: an easing function for the animation
    @objc open func animate(xAxisDuration: TimeInterval, easing: CHChartEasingFunctionBlock?)
    {
    ...
    /// - parameter xAxisDuration: duration for animating the x axis
    /// - parameter easingOption: the easing function for the animation
    @objc open func animate(xAxisDuration: TimeInterval, easingOption: CHChartEasingOption)
    {
    ...
    /// - parameter yAxisDuration: duration for animating the y axis
    /// - parameter easing: an easing function for the animation
    @objc open func animate(yAxisDuration: TimeInterval, easing: CHChartEasingFunctionBlock?)
    {
    ...
    /// - parameter yAxisDuration: duration for animating the y axis
    /// - parameter easingOption: the easing function for the animation
    @objc open func animate(yAxisDuration: TimeInterval, easingOption: CHChartEasingOption)
    {
    ...
    @objc open var legend: CHLegend
    {
        return _legend
    }
    
    /// - returns: The renderer object responsible for rendering / drawing the Legend.
    @objc open var legendRenderer: CHLegendRenderer!
    {
    ...
    @objc open var viewPortHandler: CHViewPortHandler!
    {
    ...
    internal var _viewportJobs = [CHViewPortJob]()
    ...
    @objc open func removeViewportJob(_ job: CHViewPortJob)
    {
    ...
    @objc open func addViewportJob(_ job: CHViewPortJob)
    {
    ...
    open func animatorUpdated(_ chartAnimator: CHAnimator)
    {
        setNeedsDisplay()
    }
    
    open func animatorStopped(_ chartAnimator: CHAnimator)
    {

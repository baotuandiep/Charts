...
open class CHScatterChartDataSet: CHLineScatterCandleRadarChartDataSet, CHIScatterChartDataSet
{
    ...
    {
        self.shapeRenderer = CHScatterChartDataSet.renderer(forShape: shape)
    }
    
    /// The IShapeRenderer responsible for rendering this DataSet.
    /// This can also be used to set a custom IShapeRenderer aside from the default ones.
    /// **default**: `SquareShapeRenderer`
    open var shapeRenderer: CHIShapeRenderer? = CHSquareShapeRenderer()
    
    @objc open class func renderer(forShape shape: Shape) -> CHIShapeRenderer
    {
        switch shape
        {
        case .square: return CHSquareShapeRenderer()
        case .circle: return CHCircleShapeRenderer()
        case .triangle: return CHTriangleShapeRenderer()
        case .cross: return CHCrossShapeRenderer()
        case .x: return CHXShapeRenderer()
        case .chevronUp: return CHChevronUpShapeRenderer()
        case .chevronDown: return CHChevronDownShapeRenderer()
        }
    }
    ...
    {
        let copy = super.copyWithZone(zone) as! CHScatterChartDataSet

...
open class CHCombinedChartData: CHBarLineScatterCandleBubbleChartData
{
    private var _lineData: CHLineChartData!
    private var _barData: CHBarChartData!
    private var _scatterData: CHScatterChartData!
    private var _candleData: CHCandleChartData!
    private var _bubbleData: CHBubbleChartData!
    ...
    @objc open var lineData: CHLineChartData!
    {
        get
        {
            return _lineData
    ...
    @objc open var barData: CHBarChartData!
    {
        get
        {
            return _barData
    ...
    @objc open var scatterData: CHScatterChartData!
    {
        get
        {
            return _scatterData
    ...
    @objc open var candleData: CHCandleChartData!
    {
        get
        {
            return _candleData
    ...
    @objc open var bubbleData: CHBubbleChartData!
    {
        get
        {
            return _bubbleData
    ...
    @objc open var allData: [CHChartData]
    {
    ...
    @objc open func dataByIndex(_ index: Int) -> CHChartData
    {
        return allData[index]
    }
    
    open func dataIndex(_ data: CHChartData) -> Int?
    {
        return allData.index(of: data)
    }
    
    open override func removeDataSet(_ dataSet: CHIChartDataSet!) -> Bool
    {
        let datas = allData
    ...
    open override func removeEntry(_ entry: CHChartDataEntry, dataSetIndex: Int) -> Bool
    {
    ...
    open override func entryForHighlight(_ highlight: CHHighlight) -> CHChartDataEntry?
    {
    ...
    @objc open func getDataSetByHighlight(_ highlight: CHHighlight) -> CHIChartDataSet!
    {  
        if highlight.dataIndex >= allData.count
        {
            return nil

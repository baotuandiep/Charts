...
open class CHCandleChartDataSet: CHLineScatterCandleRadarChartDataSet, CHICandleChartDataSet
{
    ...
    {
        guard let e = e as? CHCandleChartDataEntry
            else { return }
    ...
    open override func calcMinMaxY(entry e: CHChartDataEntry)
    {
        guard let e = e as? CHCandleChartDataEntry
            else { return }

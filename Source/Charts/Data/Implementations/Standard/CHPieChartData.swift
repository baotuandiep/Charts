...
open class CHPieChartData: CHChartData
{
    ...
    @objc open override var dataSets: [CHIChartDataSet]
    {
        get
        {
    ...
    @objc var dataSet: CHIPieChartDataSet?
    {
        get
        {
            return dataSets.count > 0 ? dataSets[0] as? CHIPieChartDataSet : nil
        }
        set
        {
    ...
    open override func getDataSetByIndex(_ index: Int) -> CHIChartDataSet?
    {
        if index != 0
        {
            return nil
    ...
    open override func getDataSetByLabel(_ label: String, ignorecase: Bool) -> CHIChartDataSet?
    {
    ...
    open override func addDataSet(_ d: CHIChartDataSet!)
    {   
        super.addDataSet(d)
    }

...
open class CHChartData: NSObject
{
    ...
    internal var _dataSets = [CHIChartDataSet]()
    
    public override init()
    {
        super.init()
        
        _dataSets = [CHIChartDataSet]()
    }
    
    @objc public init(dataSets: [CHIChartDataSet]?)
    {
        super.init()
        
        _dataSets = dataSets ?? [CHIChartDataSet]()
        
        self.initialize(dataSets: _dataSets)
    }
    
    @objc public convenience init(dataSet: CHIChartDataSet?)
    {
        self.init(dataSets: dataSet === nil ? nil : [dataSet!])
    }
    
    internal func initialize(dataSets: [CHIChartDataSet])
    {
        notifyDataChanged()
    }
    ...
    @objc open func calcMinMax(entry e: CHChartDataEntry, axis: CHYAxis.AxisDependency)
    {
        if _yMax < e.y
        {
            _yMax = e.y
    ...
    @objc open func calcMinMax(dataSet d: CHIChartDataSet)
    {
        if _yMax < d.yMax
        {
            _yMax = d.yMax
    ...
    @objc open func getYMin(axis: CHYAxis.AxisDependency) -> Double
    {
        if axis == .left
        {
    ...
    @objc open func getYMax(axis: CHYAxis.AxisDependency) -> Double
    {
        if axis == .left
        {
    ...
    @objc open var dataSets: [CHIChartDataSet]
    {
        get
        {
            return _dataSets
    ...
    @objc open func entryForHighlight(_ highlight: CHHighlight) -> CHChartDataEntry?
    {
    ...
    @objc open func getDataSetByLabel(_ label: String, ignorecase: Bool) -> CHIChartDataSet?
    {
    ...
    @objc open func getDataSetByIndex(_ index: Int) -> CHIChartDataSet!
    {
        if index < 0 || index >= _dataSets.count
        {
            return nil
    ...
    @objc open func addDataSet(_ dataSet: CHIChartDataSet!)
    {
    ...
    @objc @discardableResult open func removeDataSet(_ dataSet: CHIChartDataSet!) -> Bool
    {
        if dataSet === nil
        {
            return false
    ...
    @objc open func addEntry(_ e: CHChartDataEntry, dataSetIndex: Int)
    {
    ...
    @objc @discardableResult open func removeEntry(_ entry: CHChartDataEntry, dataSetIndex: Int) -> Bool
    {
        // entry outofbounds
    ...
    @objc open func getDataSetForEntry(_ e: CHChartDataEntry!) -> CHIChartDataSet?
    {
        if e == nil
        {
            return nil
    ...
    @objc open func indexOfDataSet(_ dataSet: CHIChartDataSet) -> Int
    {
        for i in 0 ..< _dataSets.count
        {
            if _dataSets[i] === dataSet
    ...
    @objc open func getFirstLeft(dataSets: [CHIChartDataSet]) -> CHIChartDataSet?
    {
    ...
    @objc open func getFirstRight(dataSets: [CHIChartDataSet]) -> CHIChartDataSet?
    {
        for dataSet in _dataSets
        {
            if dataSet.axisDependency == .right
    ...
    @objc open func setValueFormatter(_ formatter: CHIValueFormatter?)
    {
    ...
    @objc open func contains(dataSet: CHIChartDataSet) -> Bool
    {
        for set in dataSets
        {
            if set === dataSet
    ...
    @objc open var maxEntryCountSet: CHIChartDataSet?
    {

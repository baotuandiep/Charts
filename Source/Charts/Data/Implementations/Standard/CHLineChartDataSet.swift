...
open class CHLineChartDataSet: CHLineRadarChartDataSet, CHILineChartDataSet
{
    @objc(LineChartMode)
    ...
    public override init(values: [CHChartDataEntry]?, label: String?)
    {
    ...
    private var _fillFormatter: CHIFillFormatter = CHDefaultFillFormatter()
    
    /// Sets a custom IFillFormatter to the chart that handles the position of the filled-line for each DataSet. Set this to null to use the default logic.
    open var fillFormatter: CHIFillFormatter?
    {
        get
        {
        ...
        set
        {
            _fillFormatter = newValue ?? CHDefaultFillFormatter()
        }
    }
    ...
    {
        let copy = super.copyWithZone(zone) as! CHLineChartDataSet

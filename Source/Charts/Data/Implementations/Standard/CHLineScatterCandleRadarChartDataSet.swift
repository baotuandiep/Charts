...
open class CHLineScatterCandleRadarChartDataSet: BarLineScatterCandleBubbleChartDataSet, CHILineScatterCandleRadarChartDataSet
{
    ...
    {
        let copy = super.copyWithZone(zone) as! CHLineScatterCandleRadarChartDataSet

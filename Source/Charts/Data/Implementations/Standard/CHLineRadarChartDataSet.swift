...
open class CHLineRadarChartDataSet: CHLineScatterCandleRadarChartDataSet, CHILineRadarChartDataSet
{
    ...
    {
        let copy = super.copyWithZone(zone) as! CHLineRadarChartDataSet

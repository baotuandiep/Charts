...
open class CHChartDataEntry: CHChartDataEntryBase
{
    /// the x value
    ...
    {
        return "CHChartDataEntry, x: \(x), y \(y)"
    }
...
// MARK: Equatable
extension CHChartDataEntry/*: Equatable*/ {
    open override func isEqual(_ object: Any?) -> Bool {
        guard let object = object as? CHChartDataEntry else { return false }

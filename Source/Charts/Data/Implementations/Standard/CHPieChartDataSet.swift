...
open class CHPieChartDataSet: CHChartDataSet, CHIPieChartDataSet
{
    ...
    internal override func calcMinMax(entry e: CHChartDataEntry)
    {
        calcMinMaxY(entry: e)
    }
    ...
    {
        let copy = super.copyWithZone(zone) as! CHPieChartDataSet

...
open class CHChartDataSet: CHChartBaseDataSet
{
    ...
    @objc public init(values: [CHChartDataEntry]?, label: String?)
    {
        self.values = values ?? []
    ...
    @objc public convenience init(values: [CHChartDataEntry]?)
    {
    ...
    @objc open var values: [CHChartDataEntry]
        {
        didSet
        {
    ...
    @objc open func calcMinMaxX(entry e: CHChartDataEntry)
    {
        if e.x < _xMin
        {
            _xMin = e.x
    ...
    @objc open func calcMinMaxY(entry e: CHChartDataEntry)
    {
        if e.y < _yMin
        {
            _yMin = e.y
    ...
    ///
    /// - parameter e:
    internal func calcMinMax(entry e: CHChartDataEntry)
    {
        calcMinMaxX(entry: e)
        calcMinMaxY(entry: e)
    }
    ...
    open override func entryForIndex(_ i: Int) -> CHChartDataEntry?
    {
    ...
    open override func entryForXValue(
        ...
        rounding: ChartDataSetRounding) -> CHChartDataEntry?
    {
    ...
    open override func entryForXValue(
        _ xValue: Double,
        closestToY yValue: Double) -> CHChartDataEntry?
    {
    ...
    open override func entriesForXValue(_ xValue: Double) -> [CHChartDataEntry]
    {
        var entries = [CHChartDataEntry]()
    ...
    open override func entryIndex(entry e: CHChartDataEntry) -> Int
    {
    ...
    /// - returns: True
    open override func addEntry(_ e: CHChartDataEntry) -> Bool
    {
        calcMinMax(entry: e)
    ...
    /// - parameter e: the entry to add
    /// - returns: True
    open override func addEntryOrdered(_ e: CHChartDataEntry) -> Bool
    {
        calcMinMax(entry: e)
    ...
    open override func removeEntry(_ entry: CHChartDataEntry) -> Bool
    {
        var removed = false
        isIndirectValuesCall = true
    ...
    {
        let entry: CHChartDataEntry? = values.isEmpty ? nil : values.removeFirst()
        return entry != nil
    }
    ...
    {
        let entry: CHChartDataEntry? = values.isEmpty ? nil : values.removeLast()
        return entry != nil
    }
    
    /// Checks if this DataSet contains the specified Entry.
    /// - returns: `true` if contains the entry, `false` if not.
    open override func contains(_ e: CHChartDataEntry) -> Bool
    {
        for entry in values
        {
            if entry == e
    ...
    {
        let copy = super.copyWithZone(zone) as! CHChartDataSet

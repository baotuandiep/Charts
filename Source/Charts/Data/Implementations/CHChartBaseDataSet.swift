...
open class CHChartBaseDataSet: NSObject, CHIChartDataSet
{
    ...
    open func entryForIndex(_ i: Int) -> CHChartDataEntry?
    {
    ...
    open func entryForXValue(
        _ x: Double,
        closestToY y: Double) -> CHChartDataEntry?
    {
        fatalError("entryForXValue(x, closestToY) is not implemented in ChartBaseDataSet")
    }
    
    open func entriesForXValue(_ x: Double) -> [CHChartDataEntry]
    {
    ...
    open func entryIndex(entry e: CHChartDataEntry) -> Int
    {
        fatalError("entryIndex(entry) is not implemented in ChartBaseDataSet")
    }
    
    open func addEntry(_ e: CHChartDataEntry) -> Bool
    {
        fatalError("addEntry is not implemented in ChartBaseDataSet")
    }
    
    open func addEntryOrdered(_ e: CHChartDataEntry) -> Bool
    {
        fatalError("addEntryOrdered is not implemented in ChartBaseDataSet")
    }
    
    @discardableResult open func removeEntry(_ entry: CHChartDataEntry) -> Bool
    {
    ...
    open func contains(_ e: CHChartDataEntry) -> Bool
    {
        fatalError("removeEntry is not implemented in ChartBaseDataSet")
    }
    ...
    open var axisDependency = CHYAxis.AxisDependency.left
    ...
    internal var _valueFormatter: CHIValueFormatter?
    
    /// Custom formatter that is used instead of the auto-formatter if set
    open var valueFormatter: CHIValueFormatter?
    {
        get
        {
            if needsFormatter
            {
                return CHChartUtils.defaultValueFormatter()
            }
    ...
    open var form = CHLegend.Form.default

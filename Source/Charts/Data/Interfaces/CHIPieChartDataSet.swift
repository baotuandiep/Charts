...
@objc
public protocol CHIPieChartDataSet: CHIChartDataSet
{
    ...
    var xValuePosition: CHPieChartDataSet.ValuePosition { get set }
    var yValuePosition: CHPieChartDataSet.ValuePosition { get set }

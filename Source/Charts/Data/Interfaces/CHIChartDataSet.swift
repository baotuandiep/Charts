...
@objc
public protocol CHIChartDataSet
{
    ...
    func entryForIndex(_ i: Int) -> CHChartDataEntry?
    ...
    func entriesForXValue(_ xValue: Double) -> [CHChartDataEntry]
    ...
    func entryIndex(entry e: CHChartDataEntry) -> Int
    ...
    func addEntry(_ e: CHChartDataEntry) -> Bool
    ...
    /// - parameter e: the entry to add
    /// - returns: `true` if the entry was added successfully, `false` ifthis feature is not supported
    func addEntryOrdered(_ e: CHChartDataEntry) -> Bool
    ...
    func removeEntry(_ entry: CHChartDataEntry) -> Bool
    ...
    func contains(_ e: CHChartDataEntry) -> Bool
    ...
    var axisDependency: CHYAxis.AxisDependency { get }
    ...
    var valueFormatter: CHIValueFormatter? { get set }

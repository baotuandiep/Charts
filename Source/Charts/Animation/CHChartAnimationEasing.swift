...
@objc
public enum CHChartEasingOption: Int
{
    case linear
    case easeInQuad
    case easeOutQuad
...
public typealias CHChartEasingFunctionBlock = ((_ elapsed: TimeInterval, _ duration: TimeInterval) -> Double)

internal func easingFunctionFromOption(_ easing: CHChartEasingOption) -> CHChartEasingFunctionBlock
{
    switch easing
    {
    case .linear:

...
public protocol CHAnimatorDelegate
{
    /// Called when the Animator has stepped.
    func animatorUpdated(_ animator: CHAnimator)
    
    /// Called when the Animator has stopped.
    func animatorStopped(_ animator: CHAnimator)
}

@objc(ChartAnimator)
open class CHAnimator: NSObject
{
    @objc open weak var delegate: CHAnimatorDelegate?
    ...
    private var _easingX: CHChartEasingFunctionBlock?
    private var _easingY: CHChartEasingFunctionBlock?
    ...
    @objc open func animate(xAxisDuration: TimeInterval, yAxisDuration: TimeInterval, easingOption: CHChartEasingOption = .easeInOutSine)
    {
    ...
    /// - parameter xAxisDuration: duration for animating the x axis
    /// - parameter easingOption: the easing function for the animation
    @objc open func animate(xAxisDuration: TimeInterval, easingOption: CHChartEasingOption = .easeInOutSine)
    {
    ...
    /// - parameter yAxisDuration: duration for animating the y axis
    /// - parameter easingOption: the easing function for the animation
    @objc open func animate(yAxisDuration: TimeInterval, easingOption: CHChartEasingOption = .easeInOutSine)
    {

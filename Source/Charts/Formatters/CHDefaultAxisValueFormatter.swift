...
open class CHDefaultAxisValueFormatter: NSObject, CHIAxisValueFormatter
{
    public typealias Block = (
        _ value: Double,
        _ axis: CHAxisBase?) -> String
    ...
    @objc public static func with(block: @escaping Block) -> CHDefaultAxisValueFormatter?
    {
        return CHDefaultAxisValueFormatter(block: block)
    }
    
    open func stringForValue(_ value: Double,
                               axis: CHAxisBase?) -> String
    {
        if let block = block {

...
open class CHDefaultValueFormatter: NSObject, CHIValueFormatter
{
    public typealias Block = (
        _ value: Double,
        _ entry: CHChartDataEntry,
        _ dataSetIndex: Int,
        _ viewPortHandler: CHViewPortHandler?) -> String
    ...
    @objc public static func with(block: @escaping Block) -> CHDefaultValueFormatter?
    {
        return CHDefaultValueFormatter(block: block)
    }

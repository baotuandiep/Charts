...
open class CHIndexAxisValueFormatter: NSObject, CHIAxisValueFormatter
{
    ...
    @objc public static func with(values: [String]) -> CHIndexAxisValueFormatter?
    {
        return CHIndexAxisValueFormatter(values: values)
    }

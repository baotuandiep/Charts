...
@objc(ChartLegend)
open class CHLegend: CHComponentBase
{
    ...
    @objc open var entries = [CHLegendEntry]()
    
    /// Entries that will be appended to the end of the auto calculated entries after calculating the legend.
    /// (if the legend has already been calculated, you will need to call notifyDataSetChanged() to let the changes take effect)
    @objc open var extraEntries = [CHLegendEntry]()
    ...
    @objc public init(entries: [CHLegendEntry])
    {
        super.init()
    ...
    @objc open func calculateDimensions(labelFont: NSUIFont, viewPortHandler: CHViewPortHandler)
    {
    ...
    @objc open func setCustom(entries: [CHLegendEntry])
    {
        self.entries = entries

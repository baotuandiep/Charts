...
@objc(ChartAxisBase)
open class CHAxisBase: CHComponentBase
{
    ...
    private var _axisValueFormatter: CHIAxisValueFormatter?
    ...
    private var _limitLines = [CHChartLimitLine]()
    ...
    @objc open var valueFormatter: CHIAxisValueFormatter?
    {
        get
        {
            if _axisValueFormatter == nil ||
                (_axisValueFormatter is CHDefaultAxisValueFormatter &&
                    (_axisValueFormatter as! CHDefaultAxisValueFormatter).hasAutoDecimals &&
                    (_axisValueFormatter as! CHDefaultAxisValueFormatter).decimals != decimals)
            {
                _axisValueFormatter = CHDefaultAxisValueFormatter(decimals: decimals)
            }
        ...
        set
        {
            _axisValueFormatter = newValue ?? CHDefaultAxisValueFormatter(decimals: decimals)
        }
    }
    ...
    @objc open func addLimitLine(_ line: CHChartLimitLine)
    {
        _limitLines.append(line)
    }
    
    /// Removes the specified ChartLimitLine from the axis.
    @objc open func removeLimitLine(_ line: CHChartLimitLine)
    {
    ...
    @objc open var limitLines : [CHChartLimitLine]
    {
        return _limitLines
    }
